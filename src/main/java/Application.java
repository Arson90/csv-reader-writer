...
public class Application {
    ...
    public static void writingCSVFile() {
        try {
            CSVWriter csvWriter = new CSVWriter(new FileWriter("salaries.csv"),
    ...
    public static void readingCSVFile() {
        try {
            ...
            count(rows); //calling the sum and average calculation method
    ...
    public static void count(List<List<String>> rows) {
